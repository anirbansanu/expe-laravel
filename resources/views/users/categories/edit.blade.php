<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4 m-lg-5">
            @forelse ($category->subCategories as $item)
                <div class="card w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 light:bg-gray-800 light:border-gray-700">
                    <h5 class="mb-3 text-base font-semibold text-gray-900 md:text-xl light:text-white">
                        {{$item->name}}
                    </h5>
                    <p class="text-sm font-normal text-gray-500 light:text-gray-400">{{ $item->description }}</p>
                    <ul class="my-4 space-y-3">
                        @forelse ($item->menus as $menu)
                            <li>
                                <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow light:bg-gray-600 light:hover:bg-gray-500 light:text-white">
                        ...
                        @empty
                            <li>
                                <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow light:bg-gray-600 light:hover:bg-gray-500 light:text-white">
                                    ...
                                    <span class="flex-1 ml-3 whitespace-nowrap">No Data</span>
                                    <span class="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-500 bg-gray-200 rounded light:bg-gray-700 light:text-gray-400">Popular</span>
                                </a>
                            </li>
                        @endforelse
                    ...
                    <div>
                        <a href="#" class="inline-flex items-center text-xs font-normal text-gray-500 hover:underline light:text-gray-400">
